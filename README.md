...
# 2025.11.26
### 변경 사항:
* android:layout_marginTop="600dp" 제거 : 화면 위치를 하드코딩 하지 않도록 수정
* android:layout_gravity="bottom" 추가 : 다양한 모바일 환경에서 화면 하단에 자연스럽게 배치되도록 변경
### 이유:
* marginTop으로 고정된 값을 사용하면 기기 해상도나 화면 크기에 따라 UI가 깨질 수 있음
* gravity 속성을 활용하면 기기별 레이아웃 차이를 고려해 유연하고 일관된 UI 배치가 가능해짐